...
$pagetitle = get_string('competencyframeworks', 'tool_learningplan');
// Set up the page.
$url = new moodle_url("/admin/tool/learningplan/competencyframeworks.php");
$PAGE->set_url($url);
...
$page = new \tool_learningplan\output\manage_competency_frameworks_page();

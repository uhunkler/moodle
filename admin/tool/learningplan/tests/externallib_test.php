...
use tool_learningplan\external;
 ...
 */
class tool_learningplan_external_testcase extends externallib_advanced_testcase {
    ...
    protected function setUp() {
        ...
        assign_capability('tool/learningplan:competencymanage', CAP_ALLOW, $creatorrole, $syscontext->id);
        assign_capability('tool/learningplan:competencyview', CAP_ALLOW, $userrole, $syscontext->id);
